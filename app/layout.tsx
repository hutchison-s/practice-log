...
export default function RootLayout({
  ...
  return (
      ...
      <html lang="en" className="bg-background">
        ...
        <body
          className={`${golos.variable} ${inter.variable} antialiased pb-20 relative min-h-[100vh] bg-[radial-gradient(circle_at_66%_30%,__var(--tw-gradient-stops))] from-indigo-950 via-background to-background print:bg-transparent`}
        >
          <UserProvider>
            <SessionProvider>
            <PageHeader />
            ...
            {children}
            <SessionOverlay />
            <footer className="absolute bottom-4 left-0 flex w-full justify-center px-2 text-txtsecondary gap-x-6 flex-wrap md:flex-nowrap">
