...
function EditGroupButton({teacher_id, group, onUpdate}: {teacher_id: string, group?: Group, onUpdate: (g: Group)=>void}) {
  ...
  return (
    <>
        <button className='bg-transparent border-[1px] border-white/25 grid place-items-center p-1 rounded' onClick={()=>setIsOpen(true)}>
            <Pencil className='text-txtprimary' aria-label="Add new group"/>
        </button>
