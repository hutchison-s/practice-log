  ...
  return (
    <>
        ...
        <ControlledModalForm 
                ...
                isOpen={isOpen}
                formClassName="grid gap-4 bg-transparent">
                    {isSubmitting
                        ...
                        <div className="flex justify-items-end">
                            <SecondaryButton type="button" size='sm' onClick={()=>{setIsOpen(false); onCancel()}} className="py-0 my-4 mx-auto">Cancel</SecondaryButton>
                        </div>
                    </>}
