...
function LibraryResourceDisplay({r}: {r: LibraryResource}) {
  ...
  return (
        ...
        r && <li className="flex gap-4 justify-between align-items-center bg-gradient-to-tl from-indigo-950/75 to-indigo-800/75 border-[1px] border-white/25 rounded p-2 w-full">
